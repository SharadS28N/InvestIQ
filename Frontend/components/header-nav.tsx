  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className="w-full px-3 sm:px-4 py-2">
        <div className="h-12 md:h-14 grid grid-cols-[auto_1fr_auto] items-center rounded-2xl border bg-white/70 dark:bg-gray-900/60 backdrop-blur supports-[backdrop-filter]:bg-white/50 shadow-md max-w-[1400px] mx-auto px-4">
        <div className="flex items-center">
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent
                side="left"
                className="h-full w-[72vw] sm:w-[300px] max-w-[320px] p-0 bg-gradient-to-b from-white/90 to-white/70 dark:from-gray-900/80 dark:to-gray-900/60 backdrop-blur-md"
        ...
        <div className="flex items-center justify-center">
          ...
          <Link href="/landing" className="flex md:hidden items-center gap-2">
            <div className="rounded-md bg-primary p-1">
              <LineChart className="h-5 w-5 text-primary-foreground" />
            </div>
            <div className="font-semibold text-lg text-primary">InvestIQ</div>
        ...
        <div className="hidden md:flex items-center justify-end pr-2 md:pr-4">
          <ClientAuthCheck />
        </div>
       </div>
     </div>
